"""collectors/public/elevations.py – collects public IR elevations dataset."""
...
_log = get_logger("public.elevations", "public.log")
DATASET_NAME = "elevations"
...
def collect(raw_dir: Path, *, source_url: str, timeout: int = 60, overwrite: bool = False) -> tuple[list[dict[str, Any]], ValidationResult]:
    ...
    try:
        ...
        _log.error("Failed to fetch elevations: %s", exc)
