"""collectors/public/timetables.py – collects public IR timetables dataset."""
...
_log = get_logger("public.timetables", "public.log")
DATASET_NAME = "timetables"
...
def collect(raw_dir: Path, *, source_url: str, timeout: int = 60, overwrite: bool = False) -> tuple[list[dict[str, Any]], ValidationResult]:
    ...
    try:
        ...
        _log.error("Failed to fetch timetables: %s", exc)
