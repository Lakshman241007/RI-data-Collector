"""collectors/public/facilities.py – collects public IR facilities dataset."""
...
_log = get_logger("public.facilities", "public.log")
...
def collect(raw_dir: Path, *, source_url: str, timeout: int = 60, overwrite: bool = False) -> tuple[list[dict[str, Any]], ValidationResult]:
    ...
    try:
        ...
        _log.error("Failed to fetch facilities: %s", exc)
