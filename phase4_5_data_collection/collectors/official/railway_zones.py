"""collectors/official/railway_zones.py – collects official IR railway zones data."""
...
_log = get_logger("official.railway_zones", "official.log")
DATASET_NAME = "railway_zones"

def collect(raw_dir: Path, *, source_url: str, timeout: int = 60, overwrite: bool = False) -> tuple[list[dict[str, Any]], ValidationResult]:
    """Download railway zones and return (records, ValidationResult)."""
    ...
    try:
        ...
        _log.error("Failed to fetch railway_zones: %s", exc)
