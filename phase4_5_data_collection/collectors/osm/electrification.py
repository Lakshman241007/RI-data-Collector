"""
collectors/osm/electrification.py
Collects OSM railway electrification data via Overpass API.
...
def collect(
    ...
    *,
    ...
    """
    Collect OSM electrification dataset.
